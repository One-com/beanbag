...
/*
 * config.url            {String|Array} The complete url to the database.
...
_.extend(BeanBag.prototype, {
    ...
    getAgent: function () {
        if (!this.agent) {
            var agentOptions = {};
            ['cert', 'key', 'ca', 'keepAlive', 'keepAliveMsecs', 'maxSockets', 'maxFreeSockets', 'rejectUnauthorized'].forEach(function (propertyName) {
